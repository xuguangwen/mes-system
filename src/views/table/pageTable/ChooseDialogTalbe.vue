<template>
  <div class="hello">
    ...
    <el-dialog title="客户选择" :visible.sync="dialogVisible" width="80%">
      ...
      <el-table :data="tableData" ref="table1" @selection-change="handleSelectionChange">
      ...
      <el-pagination :page-size="pagination.pageSize" @current-change="currentChange" :current-page="pagination.pageNumber" :page-sizes="pagination.pageSizes" :total="pagination.totalRows" :layout="pagination.layout" @size-change='sizeChange'>
      </el-pagination>
    </el-dialog>
  </div>
</template>

/*
 * @Author: xgw 
 * @Date: 2019-05-13 11:01:20 
 * @Last Modified by: xgw
 * @Last Modified time: 2019-05-14 19:14:59
 */
<!--工序管理——工艺概览-->
<template>
  <div class="processOverview">
    <div class="leftBox">
      <div class="searchDiv">
        <el-input placeholder="输入工序版本名称关键字" v-model="processName">
    ...
    <div class="rightBox">
      ...
      <div class="searchContent">
        <el-table :data="tableData" v-loading="tableLoading" class="tableCard">
          ...
          <el-table-column prop="name" label="工序版本名称" align="center">
          </el-table-column>
    ...
    <!-- 查看工序信息弹窗 -->
    <!-- 查看工序信息弹窗 -->
    <el-dialog title="查看工序详情" :visible.sync="processDetailDialog" width="500px" class="detailDialog">
      <div class="detail">
        <p>工序名称：</p>
        <p>工序代码：</p>
        <p>创建人：</p>
